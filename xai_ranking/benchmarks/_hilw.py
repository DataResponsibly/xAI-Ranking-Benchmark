...
def human_in_the_loop_experiment(X, score_function, upper_bound=1, lower_bound=None):
...
def human_in_the_loop_batch_experiment(X, score_function, upper_bound=1, lower_bound=None, batch_size=10, random_state=42):
    if lower_bound is None:
        lower_bound = X.shape[0]
